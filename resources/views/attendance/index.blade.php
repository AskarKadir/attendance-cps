                ...
                @can('admin')
                    ...
                    <div class="px-6 pt-6 mb-5 md:w-1/2 2xl:w-1/2">
                        ...
                        <form class="flex items-center gap-2">
                            ...
                            <x-primary-button class="bg-white sm:rounded-lg flex items-center gap-2 whitespace-nowrap" >
                                <a href="attendance/exportpdf" class="btn btn-sm btn-success">Export PDF</a>
                            </x-primary-button>
                        </form>
                    </div>
                    ...
                    <!-- <div class="px-6 pt-6 mb-5 md:w-1/2 2xl:w-1/2">
                        ...
                        <form class="flex items-center gap-2">
                            <x-text-input id="search" name="search" type="text" class="w-full"
                                placeholder="Search by name or status ..." value="{{ request('search') }}" autofocus />
                            <x-text-input id="search" name="search" type="date" class="w-full"
                                placeholder="Search by attendance date ..." value="{{ request('search') }}" autofocus />
                            <x-primary-button type="submit">
                                {{ __('Search') }}
                            </x-primary-button>
                            @can('admin')
                        ...
                        <tbody>
                            @forelse ($attendances as $attendance)
                                <tr class="odd:bg-white odd:dark:bg-gray-800 even:bg-gray-50 even:dark:bg-gray-700">
                                    ...
                                    <td>
                                        <p>{{ $attendance->created_at->format('D, d F Y') }}</p> <!--format tampilan attendance_date-->
                                    </td>
